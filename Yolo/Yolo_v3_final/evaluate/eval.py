...
from common.colorpatch_dataset import ColorPatch_Dataset
...
def evaluate(config):
    ...
    # DataLoader
    dataloader = torch.utils.data.DataLoader(ColorPatch_Dataset(config["val_path"],
    ...
    for step, samples in enumerate(dataloader):
        ...
        with torch.no_grad():
            ...
            output = non_max_suppression(output, config["yolo"]["classes"], conf_thres=0.45)
            #  calculate
