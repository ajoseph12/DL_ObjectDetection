...
def create_modules(blocks):
    ...
    """
    This function takes a list 'blocks' returned by the 'parse_cfg' 
    function and return a nn.ModuleList() and informaiton about the 
    Yolo network

    Note:
    - output_filters object will suffice (need not have prev_filters too)
    """
...
model.load_darknet_weights("Data/darknet53_weights_pytorch.pth")
inp = get_test_input()
